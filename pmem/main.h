...
#include "../app/AppOwire/param.h"
#include "../app/AppOwire/main.h"
#include "../app/param.h"
#include "../app.h"
...
extern int pmem_getOwireParam(AppOwireParam *item, size_t ind) ;
extern int pmem_saveOwireParam(const AppOwireParam *item, size_t ind);
